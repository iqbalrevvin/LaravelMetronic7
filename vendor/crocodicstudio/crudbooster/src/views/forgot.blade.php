                       ...
                       {{--  <div class="kt-login__head">
                        ...
                        <div class="kt-login__body">
                            ...
                            <div class="kt-login__form">
                                ...
                                @endif
                                <form class="kt-form" autocomplete='off' action="{{ route('postForgot') }}" method="post">
                                    ...
                                    <div class="kt-login__actions">
                                        <a href="{{route("getLogin")}}" class="kt-link kt-login__link-forgot">
                                            Kembali Login ?
                                        </a>
