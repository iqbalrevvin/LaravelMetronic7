                        ...
                        <div class='form-group'>
                            <label class='label-setting' title="{{$s->name}}">
                                ...
                                <a style="visibility:hidden" href='{{CRUDBooster::mainpath("edit/$s->id")}}' 
                                    title='Ubah Komponen Pengaturan' class='btn btn-box-tool'>
                                    <i class='fa fa-edit'></i>
                                </a>
                                <a style="visibility:hidden" href='javascript:;' title='Hapus Komponen Pengaturan' class='btn btn-box-tool'
                            ...
                            switch ($s->content_input_type) {
                                ...
                                case 'upload_image':
                                    if ($value) {
                                        ...
                                        echo "<div class='pull-right'><a class='btn btn-danger btn-elevate btn-circle btn-icon' onclick='if(confirm(\"Are you sure want to delete ?\")) location.href=\"".CRUDBooster::mainpath("delete-file-setting?id=$s->id")."\"' title='Click here to delete'><i class='fa fa-trash'></i></a></div>";
                                    } else {
