                ...
                @if($button_table_action)
                    @if(CRUDBooster::isUpdate() || CRUDBooster::isDelete() || CRUDBooster::isRead())
                        <th width='{{$button_action_width?:"auto"}}' style="text-align:center">
                            {{-- {{trans("crudbooster.action_label")}} --}} Operasi
                        </th>
                    @endif
                @endif
            </tr>
...
<div class="col-md-4" style="margin:30px 0;">
    <span class="pull-left">{{ trans("crudbooster.filter_rows_total") }}
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            <i class='fa fa-filter'></i> {{trans("crudbooster.filter_dialog_title")}}
                        </h4>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id='export-data'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            <i class='fa fa-download'></i> {{trans("crudbooster.export_dialog_title")}}
                        </h4>
                        <button class="close" aria-label="Close" type="button" data-dismiss="modal">
                            <span aria-hidden="true">×</span>
                        </button>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='help-block'>
                                        ...
                                        <input type='checkbox' name='default_paper_size'value='1'/> 
                                            {{trans("crudbooster.export_dialog_set_default")}}
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
