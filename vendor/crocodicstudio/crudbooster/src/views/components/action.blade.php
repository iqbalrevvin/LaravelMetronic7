            ...
            @if(CRUDBooster::isRead() && $button_detail)
                <li>
                    <a class='btn-detail' title='{{trans("crudbooster.action_detail_data")}}'
                       href='{{CRUDBooster::mainpath("detail/".$row->$pk)}}'><i
...
@else
    ...
    @if(CRUDBooster::isRead() && $button_detail)
       <a href='{{CRUDBooster::mainpath("detail/".$row->$pk)}}' 
            class="btn btn-sm btn-outline-brand btn-elevate btn-circle btn-elevate-air btn-icon btn-detail nav_block"
            title='{{trans("crudbooster.action_detail_data")}}'>
            <i class="flaticon-more-v4"></i>
        </a>
    @endif

    @if(CRUDBooster::isUpdate() && $button_edit)
        <a href='{{CRUDBooster::mainpath("edit/".$row->$pk)}}' 
            class="btn btn-sm btn-outline-success btn-elevate btn-circle btn-elevate-air btn-icon btn-edit nav_block"
            title='{{trans("crudbooster.action_edit_data")}}'>
    ...
    @if(CRUDBooster::isDelete() && $button_delete)
        <?php $url = CRUDBooster::mainpath("delete/".$row->$pk);?>
        <a href='javascript:;' 
            class="btn btn-sm btn-outline-danger btn-elevate btn-circle btn-elevate-air btn-icon btn-delete"
            title='{{trans("crudbooster.action_delete_data")}}'
