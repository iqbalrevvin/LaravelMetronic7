    ...
    public function getIndex()
    {
        ...
        foreach ($data['result'] as $row) {
            ...
            if ($this->button_bulk_action) {
                ...
                $html_content[] = "<label class='kt-checkbox kt-checkbox--brand'><input type='checkbox' name='checkbox[]' class='checkbox' value='".$row->{$tablePK}."'><span></span></label>";
            ...
            if ($this->button_table_action):
                ...
                $html_content[] = "<div class='button_action' style='text-align:center'>".view('crudbooster::components.action', compact('addaction', 'row', 'button_action_style', 'parent_field'))->render()."</div>";
