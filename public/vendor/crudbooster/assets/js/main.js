// request permission on page load
    ...
    function loader_notification() {       
      ...
      $.get(NOTIFICATION_JSON,function(resp) {
		  ...
		  $('.notifications-menu .kt-head__title').text(NOTIFICATION_YOU_HAVE +' '+resp.total+' '+ NOTIFICATION_NOTIFICATIONS);
          var htm = '';
          $.each(resp.items,function(i,obj) {
              htm += '<a href="'+ADMIN_PATH+'/notifications/read/'+obj.id+'?m=0" class="kt-notification__item"><div class="kt-notification__item-icon"><i class="flaticon2-notification kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">'+obj.content+'</div><div class="kt-notification__item-time">Notifikasi Belum Terbaca</div></div></a>';
          })  
